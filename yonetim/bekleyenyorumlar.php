    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          ...
          <p>Bekleyen Yorumlar Listesi</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Bekleyen Yorumlar</li>
          <li class="breadcrumb-item active"><a href="#">Bekleyen Yorumlar Listesi</a></li>
        </ul>
      </div>
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="tile">
            <?php
              ...
              WHERE yorum_durum=:d
              ORDER BY id DESC LIMIT :goster, :lim");
              ...
              if($sorgu->rowCount()){
            ?>
            <h3 class="tile-title">Bekleyen Yorumlar Listesi(<?php echo $toplam;?>)</h3>
