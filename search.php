...
?>
        <div class="s-content">   
            <div class="masonry-wrap">
                <h3 class="entry__title">Arama Sonuçları (<?php echo $toplam;?>)</h3>
                 <h6><?php echo $q;?> kelimesine göre arama sonuçları</h6>
                <div class="masonry">
 ...
 <div class="row">
  ...
  <ul>
              ...
              <?php
                                ...
                                echo '<div class="alert alert-danger">'.$q.' Kelimesine uygun bir yazı bulunamdı.</div>';
                            }                                              
                            ?>
         </nav>
                </div>
